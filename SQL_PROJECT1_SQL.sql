...
Query.  Select Count(*) as Customers From Customers_new
        Select Count(*) as Transactions From Transactions_new
         Select Count(*) as Product_Cat_info From prod_cat_info

		 method used ."select"statement "count" function
 
  #there are 5647 rows in customers table
  #there are 23053 rows in transactions table
  # there are 23 rows in prod_cat_info

Q2. What is the total number of transactions that have a return?
          
Query.  Select Count(*) as No_of_transactions From Transactions_new
        WHERE total_amt < 0

		method used."select"statement"count"function  "where" clause

  #the total number of transactions that have return is 2177
...
*Query.	 Select
		 ...
		 method used."select"statement "datediff","Min","Max" functions
     #total_days = 1430
	 #total_months = 47
	 #total_years = 3
...
Query.		     Select * From prod_cat_info
		  ...
		  *Methods Used.   "select" Statement,"Where" Clause
...
*Query.	         Select Top 1 city_code, count(*) AS Customers_new_count
                 From Customers_new
                 Group by city_code
                 Order by Customers_new_count DESC
...
*Query.           Select prod_cat, prod_subcat, SUM(total_amt) AS total_revenue from Customers_new c
                  JOIN Transactions_new t ON c.customer_Id = t.cust_id
...
**Q14. What are the categories for which average revenue is above the overall average.
		             ...
		             SELECT ROUND(AVG(total_amt), 2) AS Overall_Avg_Revenue
                   FROM Transactions_new;
